...
.activedate{background-color:#ed1c24;}
        ...
        <!--code asha ends-->
            ...
            <div class="section-full bg-gray-1 content-inner about-us pt-5 allevents-sec">
						...
						<li class="category_{{$event->category_name}} design card-container col-lg-3 col-md-6 col-sm-6 event-mobileview1">
								<div class="listing-bx featured-star-right m-b30 style-2">
									...
									<div class="listing-info info1">
										...
										<ul class="place-info ">
											<li class="place-location"><i class="fa fa-map-marker"></i><a href="{{url('event/'.$event->regtime)}}" class="all-venue">{{$event->location}}</a></li>
                ...
                <a href="event-list-page.php"><button class="site-button text-uppercase radius-xl align-self-center allviewmore">View All Events &nbsp; <i class="fa fa-chevron-right"></i></button></a>
                    ...
                    @foreach($devents as $devent)	
                        <div class="item">
                            <div class="listing-bx featured-star-right m-b30 style-2 box-event-border dining-evntsingle-box">
                                <div class="listing-media">
                                    <a href="{{url('event/'.$devent->regtime)}}"><img src="../{{$devent->fimage1}}" class="diningimg-event" alt=""></a>
                                    <ul class="wish-bx">
                                        <li><a class="like-btn" href="#"><i class="fa fa-heart"></i> </a></li>      
                                    </ul>
                                    <ul class="featured-star category_tab">
                                        <a href="{{url('event/'.$devent->regtime)}}" class="category_txt">{{$event->subcategory_name}}</a>
                                    </ul>
                                </div>
                                <div class="listing-info info1 dining-content-event">
                                    <h3 class="title"><a href="{{url('event/'.$devent->regtime)}}" class="diningevent-head">{{substr($devent->title,0,15)}}...</a></h3>
                                    <h6 class="post-date"> <i class="icon-calendar calendericon"></i> <span class="categorydate"> {{date('D, d M Y',strtotime($devent->start_date))}}</span> </h6>
                                    <ul class="place-info ">
                                        <li class="place-location"><i class="fa fa-map-marker"></i><a href="venue.html" class="all-venue">{{$devent->location}}</a></li>
                                        <li class="open arrow_btn lap-view-arrow"><a href="{{url('event/'.$devent->regtime)}}" class="arrow_txt"><i class="fa fa-chevron-right"></i></a></li>
                                    </ul>
                                    <ul class="place-info mob-view-arrow">
                                        <li class="open arrow_btn "><a href="{{url('event/'.$devent->regtime)}}" class="arrow_txt"><i class="fa fa-chevron-right"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="section-full bg-gray content-inner about-us nightclubevent-area">
                <div class="container">
                    ...
                    <div class="item">
                            <div class="listing-bx featured-star-right m-b30 style-2 box-event-border dining-evntsingle-box">
                                <div class="listing-media">
                                    <a href="{{url('event/'.$nevent->regtime)}}"><img src="../{{$nevent->fimage1}}" class="diningimg-event" alt=""></a>
                                    <ul class="wish-bx">
                                        <li><a class="like-btn" href="#"><i class="fa fa-heart"></i> </a></li>      
                                    </ul>
                                    <ul class="featured-star category_tab">
                                        <a href="{{url('event/'.$nevent->regtime)}}" class="category_txt">{{$nevent->subcategory_name}}</a>
                                    </ul>
                                </div>
                                <div class="listing-info info1 dining-content-event">
                                    <h3 class="title"><a href="{{url('event/'.$nevent->regtime)}}" class="diningevent-head">{{substr($nevent->title,0,15)}}...</a></h3>
                                    <h6 class="post-date"> <i class="icon-calendar calendericon"></i> <span class="categorydate"> {{date('D, d M Y',strtotime($nevent->start_date))}}</span> </h6>
                                    <ul class="place-info ">
                                        <li class="place-location"><i class="fa fa-map-marker"></i><a href="venue.html" class="all-venue">{{$nevent->location}}</a></li>
                                        <li class="open arrow_btn lap-view-arrow"><a href="{{url('event/'.$nevent->regtime)}}" class="arrow_txt"><i class="fa fa-chevron-right"></i></a></li>
                                    </ul>
                                    <ul class="place-info mob-view-arrow">
                                        <li class="open arrow_btn "><a href="{{url('event/'.$nevent->regtime)}}" class="arrow_txt"><i class="fa fa-chevron-right"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
