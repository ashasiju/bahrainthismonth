...
.activedate{background-color:#ed1c24;}
                    ...
                    <div class="search-filter filter-style1">
                        ...
                        {{ csrf_field() }}
                            <div class="input-group">
                                ...
                                <input type="date" value="{{$sevent_date}}" name="event_date" class="form-control formevent-1" placeholder="">
        ...
        @foreach($events as $event)
           ...
           // echo $i.$i%5;
            ...
            ?>
                                        <div class="col-home <?php if($i<=4) echo 'mobevent';?> <?php echo 'category_'.$event->category_name;?>">
                                            <div class="listing-bx featured-star-right m-b30 style-2">
                                                ...
                                                <div class="listing-info info1">
                                                    ...
                                                    <h6 class="post-date"> <i class="icon-calendar calendericon"></i> <span class="categorydate">{{ \DateTime::createFromFormat('d/m/Y', $event->start_date)->format('D, d M Y') }}
                                                    </span> </h6>
                                                    <ul class="place-info ">
