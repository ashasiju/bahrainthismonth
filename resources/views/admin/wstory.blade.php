            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-sm-8 col-4">
                        <h4 class="page-title">Web Stories <span style="font-size:16px;color:#888da8;">Manage Web Story</span></h4>
                    </div>
                    <div class="col-lg-8">
                    ...
                    <div class="col-sm-4 col-8 text-right m-b-30">
                        <a href="{{ url('/newwstory') }}" class="btn btn-primary btn-rounded pull-right" ><i class="fa fa-plus"></i> Add New Web Story
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table m-b-0 datatable" id="" >
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $i}}</td>
                                    <td>{{$cat->name}}</td>
                                    <td>@if($cat->type=='1') Youtube @elseif($cat->type=='0') Instagram @endif
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{url('/viewwstory/'.$cat->subid)}}"  title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="{{url('/deletewstory/'.$cat->subid)}}" onClick="return confirm('Are you sure to Delete??');" title="Delete"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
...
//alert(token);
                $.ajax({
                    ...
                    url: "<?php echo route('wstory-status') ?>",
                    ...
                    success: function(data) {
                        //$("#wstoryinfo").load("#wstoryinfo");
                        alert("Status Updated");
                        location.reload(true); 
                        //$("#wstoryinfo").empty();
       // $("#wstoryinfo").load(location.href + " #wstoryinfo>*", "");
