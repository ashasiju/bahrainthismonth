...
<body>
            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-sm-8 col-4">
                        <h4 class="page-title">Links <span style="font-size:16px;color:#888da8;">Manage Links</span></h4>
                    </div>
                    <div class="col-lg-8">
                    ...
                    <div class="col-sm-4 col-8 text-right m-b-30">
                        <a href="{{ url('/newlink') }}" class="btn btn-primary btn-rounded pull-right" ><i class="fa fa-plus"></i> Add New link</a>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table m-b-0 datatable" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                    <td>{{ $i}}</td>
                                        <td>@if($link->type=='1') Information @elseif($link->type=='2') Link @endif</td>
                                        <td>{{$link->title}}</td>
                                        <td>{{$link->url}}</td>
                                        <td class="text-left">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{url('/viewlink/'.$link->regtime)}}"  title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="{{url('/deletelink/'.$link->id)}}" onClick="return confirm('Are you sure to Delete??');" title="Delete"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
    ...
    function myFunction(x, y) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('link-status') ?>",
