            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-sm-8 col-4">
                        <h4 class="page-title">Tags <span style="font-size:16px;color:#888da8;">Manage Tags</span></h4>
                    </div>
                    <div class="col-lg-8">
                    ...
                    <div class="col-sm-4 col-8 text-right m-b-30">
                        <a href="{{ url('/newtag') }}" class="btn btn-primary btn-rounded pull-right" ><i class="fa fa-plus"></i> Add New Tag</a>
                    </div>
                </div>
                                    ...
                                    <td>{{ $i}}</td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{url('/viewtag/'.$tag->id)}}"  title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="{{url('/deletetag/'.$tag->id)}}" onClick="return confirm('Are you sure to Delete??');" title="Delete"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
