...
<div class="content container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">updates <span style="font-size:16px;color:#888da8;">Add update</span> </h4>
                    </div>
                </div>
                <div class="col-lg-8">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('/updates')}}">updates List</a></li>
...
<!--<div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="card-title">1. Add Update</h4>
                                        <div class="form-group">
