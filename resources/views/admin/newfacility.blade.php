...
<div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{url('/postfacility')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            <div class="card-box">
                            @if(count($errors)>0)
...
@endif
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required type="file" name="image"  id="image" onchange="checkFileDetails()">
                                    </div>
