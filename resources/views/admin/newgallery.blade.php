...
<div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{url('/postgallery')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            <div class="card-box">
                            @if(count($errors)>0)
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required class="form-control" name="description" id="description" placeholder=""></textarea>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select" class="form-control" name="subcategory">
                                                ...
                                                <option value="{{$tag->id}}">{{$tag->subcategory_name}}</option>
                                                @endforeach
</select>                                        </div>
                                    ...
                                    <div class="col-md-6">
                                       <!-- <h4 class="card-title">2. Administrator Options</h4>-->
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control datetimepicker" name="album_date" >
                                        </div>
