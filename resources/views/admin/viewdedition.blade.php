...
@foreach($dedition as $cat)

@endforeach
<div class="content container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">PDF Edition <span style="font-size:16px;color:#888da8;">Edit PDF Edition</span> </h4>
                    </div>
                </div>
                <div class="col-lg-8">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('/dedition')}}">PDF Edition List</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Edit PDF Edition</li>
                                    </ol>
                                </nav>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ url('/updatededition') }}" method="post">
                        {{ csrf_field() }}
                            <div class="card-box">
                            @if(count($errors)>0)
