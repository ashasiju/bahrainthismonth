...
<div class="content container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Cms Menu <span style="font-size:16px;color:#888da8;">Add Cms Menu</span> </h4>
                    </div>
                </div>
                <div class="col-lg-8">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('/cmsmenu')}}">Cms Menu List</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Edit Cms Menu</li>
                                    </ol>
                                </nav>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ url('/updatecmsmenu') }}" method="post">
                        {{ csrf_field() }}
                            <div class="card-box">
                            @if(count($errors)>0)
