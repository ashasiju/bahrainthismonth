...
<body>
            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-sm-8 col-4">
                        <h4 class="page-title">Updates <span style="font-size:16px;color:#888da8;">Manage Updates</span></h4>
                    </div>
                    <div class="col-lg-8">
                    ...
                    <div class="col-sm-4 col-8 text-right m-b-30">
                        <a href="{{ url('/newupdate') }}" class="btn btn-primary btn-rounded pull-right" ><i class="fa fa-plus"></i> Add New update</a>
                    </div>
                </div>
                                    ...
                                    <td>{{ $i}}</td>
                                        ...
                                        <td class="text-left">
                                            <div class="dropdown action-label" >
                                                <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
                                                    <i class="fa fa-dot-circle-o text-danger"></i> @if($update->status=='0') Inactive @elseif ($update->status=='1') Active @endif
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="javascript:myFunction('1', {{ $update->id }})"><i class="fa fa-dot-circle-o text-info"></i> Active</a>
                                                    <a class="dropdown-item" href="javascript:myFunction('0', {{ $update->id }})"><i class="fa fa-dot-circle-o text-info"></i> Inactive</a>
                                                        </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{url('/viewupdate/'.$update->regtime)}}"  title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="{{url('/deleteupdate/'.$update->id)}}" onClick="return confirm('Are you sure to Delete??');" title="Delete"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
    ...
    function myFunction(x, y) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('update-status') ?>",
