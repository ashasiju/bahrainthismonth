...
@foreach($bottom_banner as $cat)

@endforeach
<div class="content container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">bottom Ads <span style="font-size:16px;color:#888da8;">Add bottom Ads</span> </h4>
                    </div>
                </div>
                <div class="col-lg-8">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('/bottom_banner')}}">bottom Ads List</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Edit bottom Ads</li>
                                    </ol>
                                </nav>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ url('/updatebottom_banner') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            <div class="card-box">
                            @if(count($errors)>0)
...
<span class="note_txt"> Image Dimensions Min : <b id="">728px X 90Px</b> , Type :<b>gif,jpeg,jpg,png</b> only allowed </span>
</div>
                                </div>
                                <div class="col-sm-4">
